public class NumbersAtMostNDigitGivenSet {
    ...
    public int solve(int index, boolean tight, boolean started, int cnt, int mask, char[]cn, Integer[][][][] dp){
        ...
        if(dp[index][tight?1:0][started?1:0][cnt]!=null) return dp[index][tight?1:0][started?1:0][cnt];
    ...
    public static void main(String[] args) {
        NumbersAtMostNDigitGivenSet soln= new NumbersAtMostNDigitGivenSet();
        System.out.println(soln.atMostNGivenDigitSet(new String[]{"1","3","5","7"},100));
        System.out.println(soln.atMostNGivenDigitSet(new String[]{"1","4","9"},1000000000));
        System.out.println(soln.atMostNGivenDigitSet(new String[]{"1","2","3","4","5","6","7","8","9"},1000000000));
    }
}
